...
\end{divisionexercise}%
\begin{divisionexercise}{10}{}{}{g:exercise:idm34736981525248}%
...
%
\typeout{************************************************}
\typeout{Chapter 3 Graphs on Surfaces}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 3.1 Introduction to Graphs on Surfaces}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.1.1 The Utilities Problem}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 3.2 The planarity algorithm for Hamiltonian graphs}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.2.1 Stereographic Projection and Unnecessary cases}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.2.2 The planarity algorithm}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 3.3 Kuratowski's Theorem}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.3.1 Planarity, subgraphs, and subdivisions}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.3.2 Kuratowski's Theorem}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.3.3 Applying Kuratowski's Theorem}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 3.4 Drawing Graphs on Other surfaces}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.4.1 Motivation and culture: Manifolds and Surfaces}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.4.2 Graphs on the Torus}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.4.3 Möbius strip}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 3.5 Euler's Theorem}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.5.1 Counting faces}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 3.5.2 Applications of Euler's theorem}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 4.1 Chromatic number}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 4.2 Chromatic index and applications}
\typeout{************************************************}
%
...
\begin{theorem}{}{}{g:theorem:idm34736980643808}%
For any graph \(\bfG\) we have \(\chi^\prime(\bfG)\geq\Delta(\bfG)\)%
\end{theorem}
\begin{proof}{}{g:proof:idm34736980642528}
...
\begin{theorem}{Vizing's Theorem.}{}{g:theorem:idm34736980638816}%
For any graph \(\bfG\) we have \(\Delta(\bfG)\leq \chi^\prime(\bfG)\leq \Delta(\bfG)+1\)%
\end{theorem}
\begin{proof}{}{g:proof:idm34736980637120}
...
%
\typeout{************************************************}
\typeout{Section 4.3 Introduction to the chromatic polynomial}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4.3.1 Definition and examples}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4.3.2 Gluing}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4.3.3 Case by case analysis}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section 4.4 Chromatic Polynomial continued}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4.4.1 Deletion-Contraction}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Subsection 4.4.2 Chromatic polynomial is a polynomial}
\typeout{************************************************}
%
